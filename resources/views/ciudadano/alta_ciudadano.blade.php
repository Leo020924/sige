...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('alta_ciudadano.store') }}" method="POST">
            @csrf
            ...
            <!-- Otros campos para los datos de la dirección, contacto y más -->
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="estado" name="estado" required value="{{ old('estado') }}">
                @error('estado')
                    <div style="color: red; font-size: 14px;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="num_exterior" name="num_exterior" value="{{ old('num_exterior') }}">
                @error('num_exterior')
                    <div style="color: red; font-size: 14px;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="num_interior" name="num_interior" value="{{ old('num_interior') }}">
                @error('num_interior')
                    <div style="color: red; font-size: 14px;">{{ $message }}</div>
                @enderror
            </div>
